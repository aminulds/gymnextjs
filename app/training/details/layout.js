                ...
                <div className="row g-4">
                    ...
                    <div className="col-12 col-md-4">
                                        ...
                                        <>
                                            {item.category === 'training' && (popularItemLimit += 1) <= 4 && (
                                                <div className="col" key={item.id}>
                                                    <Card img={item.image} title={item.title} url="/training/details" description={item.description} categoryIcon={item.categoryIcon} recomended={true} />
                                                </div>
                                            )}
                                        </>
                                    ))}
                        ...
                        <div className="mt-4 d-flex align-items-center justify-content-center">
                            <Link href="/training" className="btn btnPrimary rounded-pill d-flex align-items-center justify-content-around ">
                                Latest Training
                                <span className="fs-4">
                                    <MdArrowRightAlt />
                                </span>
