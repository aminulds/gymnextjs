        ...
        <div className="col-12 col-lg-10">
            <div className="mainContent">
                ...
                <div className="sectionTitle">
                    <h4 className="title">Popular Training</h4>
                </div>
                                ...
                                <>
                                    {item.category === 'training' && (popularItemLimit += 1) <= 4 && (
                                        <div className="col" key={item.id}>
                                            <Card img={item.image} title={item.title} url="/users/training/details" description={item.description} categoryIcon={item.categoryIcon} />
                                        </div>
                                    )}
                                </>
                            ))}
                ...
                {/* All Discussions */}
                <div className="sectionTitle">
                    <h4 className="title">All Training</h4>
