                ...
                <div className="row g-4">
                    ...
                    <div className="col-12 col-md-4">
                                        ...
                                        <>
                                            {item.items.slice(0, 4).map((item) => (
                                                <div className="col" key={item.id}>
                                                    <Card img={item.image} title={item.title} url="/events/details" description={item.description} categoryIcon={item.categoryIcon} recomended={true} />
                                                </div>
                                            ))}
                                        </>
                                    )}
                        ...
                        <div className="mt-4 d-flex align-items-center justify-content-center">
                            <Link href="/events" className="btn btnPrimary rounded-pill d-flex align-items-center justify-content-around ">
                                Latest Events
                                <span className="fs-4">
                                    <MdArrowRightAlt />
                                </span>
